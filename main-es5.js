...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _products_bar_products_bar_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var Button = function Button(icon, link) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(detector) {
        _classCallCheck(this, AppComponent);

        this.detector = detector;
        this.sunIconPath = 'assets/images/sun.svg';
        this.moonIconPath = 'assets/images/moon.svg';
        this.socialButtons = [new Button("gmail", "mailto:elumixor@gmail.com"), new Button("github", "https://github.com/elumixor"), new Button("facebook", "https://www.facebook.com/elumixor"), new Button("instagram", "https://www.instagram.com/elumixor")]; // todo: implememnt here logic checking the time of the day and/or user theme to set night mode to true or false
      }
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 3,
      consts: [["id", "title"], ["id", "subtitle"], [3, "href", 4, "ngFor", "ngForOf"], [3, "selected"], [3, "href"], ["alt", "", 1, "icon", "social", 3, "src"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], _products_bar_products_bar_component__WEBPACK_IMPORTED_MODULE_2__["ProductsBarComponent"], _product_product_component__WEBPACK_IMPORTED_MODULE_3__["ProductComponent"]],
      ...
      _createClass(ProductComponent, [{
        ...
        set: function set(value) {
          ...
          if (this.product.videoUrl) {
            this.videoUrl = this.sanitizer.bypassSecurityTrustResourceUrl("https://www.youtube.com/embed/" + this.product.videoUrl + '?autoplay=1&mute=1&loop=1&playlist=' + this.product.videoUrl);
          }
        }
      }]);
